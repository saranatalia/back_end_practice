class Blog
  ...
  def initialize
    ...
    puts "Name Your Blog:"
    @title = gets.chomp
    @all_blog_posts = Array.new
    @total_blog_posts = 0
  end 

  def create_blogpost
    new_blog_post = Blog_Post.new
    puts "Here is your new blog post!"
...
second_blog_post = my_blog.create_blogpost
third_blog_post = my_blog.create_blogpost
